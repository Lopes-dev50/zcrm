            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="content-header">
                        ...
                        <form action=" {{ route('add_corretor')}}" method="post" >
                            @csrf
                        <div class="grid xl:grid-cols-3 xl:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-400 dark:text-gray-400">Email</label>
                                <input type="email" id="email" name="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"  value="">
                                </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="fgts_cliente" class="block mb-2 text-sm font-medium text-gray-400 dark:text-gray-400">CPF</label>
                                <input type="text"  name="CPF" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" id='cpfInput' placeholder='000.000.000-00' oninput='cpfChange(this.value)' value="">
                                </div>
                                ...
                                <a href="{{route('add_um_corretor',['id' =>$enc->encriptar($corretor->id )],'add_um_corretor')}}">
                           ...
                           @foreach ($corretore as $corretore )
                            <div class="grid xl:grid-cols-3 xl:gap-6">
                                <div class="relative z-0 w-20 mb-6 group">
                                    <form action=" {{ route('remove_corretor', ['id' =>$enc->encriptar($corretore->id )] )}}" method="post" >
