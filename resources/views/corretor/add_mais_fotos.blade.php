        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   <!----------inicio------>
                   <form action=" {{ route('add_fotos',['id' =>$enc->encriptar( $imovel->id )], 'add_fotos')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input class="block w-300 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" name="image" type="file" onblur="resetCountdown()">
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <div class="p-3 pr-4">
                       <div class=" bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href="{{route('deletar_foto',['id' =>$enc->encriptar($galerias->id )],'deletar_foto')}}">
