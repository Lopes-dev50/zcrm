<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{route('mobi_add_edit_imovel',['0'] ,'mobi_add_edit_imovel')}}">
                        ...
                        <br>
                            <div class="flex pl-4 ">
                                ...
                                <div class="flex items-center mr-4 pr-4 pl-4">
                                    <a href="{{route('mobi_deletar_imovel',['id' =>$enc->encriptar($imoveis->id )],'destroymobi')}}">
                                ...
                                <div class="flex items-center mr-4 pr-4">
                                    <a href="{{route('mobi_ativa_imovel',['id' =>$enc->encriptar($imoveis->id )],'ativamobi')}}">
                                ...
                                @else
                                <div class="flex items-center mr-4 pr-4">
                                    <a href="{{route('mobi_desativa_imovel',['id' =>$enc->encriptar($imoveis->id )],'desativamobi')}}">
                                ...
                                <div class="flex items-center mr-4 pr-4">
                                    <a href="{{route('mobi_ativa_destaque',['id' =>$enc->encriptar($imoveis->id )],'ativa_destaquemobi')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 " viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @else
                                <div class="flex items-center mr-4 pr-4">
                                    <a href="{{route('mobi_desativa_destaque',['id' =>$enc->encriptar($imoveis->id )],'desativa_destaquemobi')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                          </svg>
                                        </a>
                                ...
                                @endif
                                <div class="flex items-center  mr-4 pr-4">
                                    <a href="{{route('mobi_add_edit_imovel',['id' =>$enc->encriptar($imoveis->id )],'editmobi')}}">
                                ...
                                <div class="flex items-center  mr-4 pr-4">
                                    <a href="{{route('mobi_add_foto',['id' =>$enc->encriptar($imoveis->id )],'add_fotomobi')}}">
