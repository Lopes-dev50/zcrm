<x-app-layout>
    <x-slot name="header">
        ...
        @endif
     <div>
        <nav class="bg-gray-300 rounded-lg shadow py-4 ">
            <div class="max-w-7xl mx-auto px-8">
                <div class="flex items-center justify-between h-6">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-5 flex items-baseline space-x-2">
                                <a class="text-gray-300  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-md font-medium" href="/#">
                                    @can('corretor')
                                    <a href="{{route('add_edit_imovel',['0'] ,'add_edit_imovel')}}">
                                ...
                                <a class="text-gray-800 dark:text-white  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-md font-medium" href="/#">
                                    ...
                                    <a href="">
                                       <button type="button" class="py-2 px-4  bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                         Disponivel no Plano Corretor!  Mudar para plano corretor.
                                       </button>
                                            </a>
                                    @endcan
                                </a>
                                <a class="text-gray-800 dark:text-white block px-3 py-2 rounded-md text-base font-medium" href="/#">
                                    @can('corretor')
                                    <a href="{{route('list_imovel', 'index')}}">
                                        <button type="button" class="py-2 px-4  bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                        Todos imoveis
                                        </button>
                                             </a>
                    ...
                    <div class="block">
                        @foreach ($imovel as $busca )
                        @endforeach
                        <div class="md:block -mr-2 flex">
                            <form action="{{ route('buscacod','buscacod') }}" method="post" class="flex flex-col md:flex-row w-3/4 md:w-full max-w-sm md:space-x-3 space-y-3 md:space-y-0 justify-center">
                                @csrf
                                <div class=" relative ">
                        ...
                        <br>
                            <div class="flex pl-2 ">
                                ...
                                <div class="flex items-center mr-2 pr-4 pl-4">
                                    <a href="{{route('deletar_imovel',['id' =>$enc->encriptar($imoveis->id )],'destroy')}}">
                                ...
                                <div class="flex items-center mr-2 pr-4">
                                    <a href="{{route('ativa_imovel',['id' =>$enc->encriptar($imoveis->id )],'ativa')}}">
                                ...
                                @else
                                <div class="flex items-center mr-2 pr-4">
                                    <a href="{{route('desativa_imovel',['id' =>$enc->encriptar($imoveis->id )],'desativa')}}">
                                ...
                                <div class="flex items-center mr-2 pr-4">
                                    <a href="{{route('ativa_destaque',['id' =>$enc->encriptar($imoveis->id )],'ativa_destaque')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 " viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @else
                                <div class="flex items-center mr-2 pr-4">
                                    <a href="{{route('desativa_destaque',['id' =>$enc->encriptar($imoveis->id )],'desativa_destaque')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                          </svg>
                                        </a>
                                ...
                                @endif
                                <div class="flex items-center  mr-2 pr-4">
                                    <a href="{{route('add_edit_imovel',['id' =>$enc->encriptar($imoveis->id )],'edit')}}">
                                ...
                                <div class="flex items-center  mr-2 pr-4">
                                    <a href="{{route('add_foto',['id' =>$enc->encriptar($imoveis->id )],'add_foto')}}">
                              ...
                              <hr>
                              <a href="{{route('add_markting',['id' =>$enc->encriptar($imoveis->id )],'add_markting')}}">
                              <div class="basis-1/2 pt-2 pl-16 ">
                                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">ENVIAR POR E-MAIL</button>
                            </div>
                              </a>
                            </div>
                        </div>
