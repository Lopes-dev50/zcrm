...
<br>
         <div class="flex flex-nowrap" >
            <div class="basis-1 pr-4">
                <a href="{{route('funil_ativo_corretor','ativo')}}">
            ...
            <div class="basis-1 pr-4">
                <a href="{{route('funil_parado_corretor','parado')}}">
            <div class=" px-4 py-2  text-base rounded-lg text-indigo-500 border border-indigo-500 ">
                <button type="button" class="text-md text-white text-1xl relative">
                    <span class="w-6 h-4 rounded-lg absolute right-2 leading text-xs bg-green-500">
                        {{count($frio)}}
        ...
        <div class="basis-1 pr-4">
            <a href="{{route('funil_doc_corretor','documentos')}}">
        <div class=" px-4 py-2  text-base rounded-lg text-indigo-500 border border-indigo-500 ">
            <button type="button" class="text-md text-white text-1xl relative">
                <span class="w-6 h-4 rounded-lg absolute right-2 leading text-xs bg-green-500">
                    @php
    ...
    <div class="basis-1 pr-4">
        <a href="{{route('funil_pen_corretor', 'pendencia')}}">
        <div class=" px-4 py-2  text-base rounded-lg text-indigo-500 border border-indigo-500 ">
            <button type="button" class="text-md text-white text-1xl relative">
                <span class="w-6 h-4 rounded-lg absolute right-2 leading text-xs bg-green-500">
                    @php
    ...
    <div class="basis-1 pr-4">
        <a href="{{route('funil_ana_corretor','analise')}}">
        <div class=" px-4 py-2  text-base rounded-lg text-indigo-500 border border-indigo-500 ">
            <button type="button" class="text-md text-white text-1xl relative">
                <span class="w-6 h-4 rounded-lg absolute right-2 leading text-xs bg-green-500">
                    @php
    ...
    <div class="basis-1 pr-4">
        <a href="{{route('funil_vendido_corretor', 'vendido')}}">
        <div class=" px-4 py-2  text-base rounded-lg text-indigo-500 border border-indigo-500 ">
            <button type="button" class="text-md text-white text-1xl relative">
                <span class="w-6 h-4 rounded-lg absolute right-2 leading text-xs bg-green-500">
                    @php
                                        ...
                                        <table class="divide-y divide-gray-300" id="dataTable">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-300">
                                                ...
                                                <tr class="text-center whitespace-nowrap">
                                                    ...
                                                    <td class="px-6 py-4">
                                                        <div class="text-sm text-gray-500">{{ $cli->nivel_cliente}}
                                                        </div>
                                                    </td>
                                                    <td class="px-6 py-4">
