            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="content-header">
                        ...
                        <form action=" {{ route('mobi_gerente_add_leads')}}" method="post" >
                            @csrf
                        <div class="grid xl:grid-cols-3 xl:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" id="telefone" name="celular"  maxlength="15" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"  value="">
                                </div>
                                <div class="relative z-0 w-full mb-6 group">
                                        ...
                                        <div class="relative z-0 w-full mb-6 group">
                                            ...
                                            <select id="countries" name="id" class="bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                ...
                                                @foreach ($corretor as $corretors)
                                                    <option value="">{{ $corretors->name}}</option>
                                                @endforeach;
                                         </select>
                                        </div>
                            ...
                            <div class="grid xl:grid-cols-3 xl:gap-6">
                                <div class="relative z-0 w-full mb-6 group">
                                    ...
                                    <input type="number" id="valorcondominio" name="clients" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"  placeholder="{{ $leads->nome_cliente}}">
                                    </div>
                                </div>
                                @endforeach
                                @endif
