...
<div class="relative z-0 w-full mb-6 pt-4 pl-4 group">
...
<div class="relative z-0 w-full mb-6 pt-4 group">
<label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400"></label>
...
<div class="relative z-0 w-full mb-6 pt-4 pr-4 group">
    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400"></label>
...
<!---------------cards-------------------->
@if(count($imovel) > 0)
<p class="text-2xl font-bold text-center text-{{$sit->cor}}-600"> Imoveis encontratos {{count($imovel)}} </p>
@else
<br>
<p class="text-2xl font-bold text-center text-{{$sit->cor}}-600">Não encontromos o imovel. </p>
<br>
@endif
